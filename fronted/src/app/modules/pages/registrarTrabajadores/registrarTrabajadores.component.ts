...
import { ModalIngresarTrabajadorComponent } from '../modalIngresarTrabajador';
@Component({
...
export class RegistrarTrabajadoresComponent implements OnInit{ 
    ...
    modalAction(action?: Country) {
      ...
      const dialogActionDetail = this.dialog.open(ModalIngresarTrabajadorComponent, {
        width: width,
        data: {
          action: action,
        },
