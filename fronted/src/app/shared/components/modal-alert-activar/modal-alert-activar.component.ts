...
@Component({
  selector: 'app-modal-alert-activar',
  standalone: true,
  imports: [
    CommonModule,
    CommonModule,
  ...
  <h1 mat-dialog-title class="flex flex-column align-items-center justify-content-center">
    ...
    <div class="flex flex-wrap justify-content-center align-items-center text-center">
      <p>
        ¿Esta seguro que desea activar a <strong>{{ data }}</strong>?
      </p>
    </div>
  </h1>
...
export class ModalAlertActivarComponent {
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    public dialogRef: MatDialogRef<ModalAlertActivarComponent>
  ) {
